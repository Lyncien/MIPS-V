...
#endif
static const char *ng0 = "C:/Users/Administrator/Desktop/PipelineCPU_20180606_1.21/PipelineCPU_20180606_1.21/PipelineCPU/alu.v";
...
LAB85:    if (*((unsigned int *)t47) < *((unsigned int *)t49))
        goto LAB83;
...
LAB93:    if (*((unsigned int *)t51) > 0)
        goto LAB94;

LAB95:    if (*((unsigned int *)t40) > 0)
        goto LAB96;

LAB97:    memcpy(t9, t53, 8);
...
LAB67:    if (*((unsigned int *)t52) < *((unsigned int *)t53))
        goto LAB65;
...
LAB75:    if (*((unsigned int *)t64) > 0)
        goto LAB76;

LAB77:    if (*((unsigned int *)t50) > 0)
        goto LAB78;

LAB79:    memcpy(t49, t73, 8);
...
LAB76:    xsi_vlog_unsigned_bit_combine(t49, 32, t68, 32, t73, 32);
    goto LAB80;

LAB78:    memcpy(t49, t68, 8);
    goto LAB80;
...
LAB94:    xsi_vlog_unsigned_bit_combine(t9, 32, t52, 32, t53, 32);
    goto LAB98;

LAB96:    memcpy(t9, t52, 8);
    goto LAB98;
...
LAB112:    xsi_vlog_unsigned_bit_combine(t9, 32, t41, 32, t46, 32);
    goto LAB116;

LAB114:    memcpy(t9, t41, 8);
    goto LAB116;
...
extern void work_m_00000000000624848084_2725559894_init()
{
	...
	xsi_register_didat("work_m_00000000000624848084_2725559894", "isim/test_isim_beh.exe.sim/work/m_00000000000624848084_2725559894.didat");
